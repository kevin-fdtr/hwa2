...
// test checkMissingData
console.log('test util module, checkMissingData');
...
console.log(util.checkMissingData(configArray1, data1)==false ? 'pass' : 'fail');
...
console.log(util.checkMissingData(configArray2, data1)==true ? 'pass' : 'fail');
